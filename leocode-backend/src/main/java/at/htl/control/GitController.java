...
public class GitController {
    ...
    public void checkoutFolder(File dir, Example example){
        ...
        try {
            ...
            importExample("https://github.com/raphaelabl/NewLeocodeTest.git", "v1.0.0",
                    new File("target", "examples"),
                    upcp,
                    "NewTestingExample");
    ...
    private static void importExample(String repoUrl,
                                     String tag,
                                     File destination, UsernamePasswordCredentialsProvider upcp,
                                     String...exampleNames)
            throws Exception {
